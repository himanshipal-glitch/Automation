...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if profit_df.empty:
        ...
        # (Last Year provisions are NOT stored/entered in the app — the Last Year
        # Shipments workbook sheet leaves the provision / NO-DN cells blank for
        # manual entry in Excel, with a live Closing-Provision formula.)
