...
def apply_frozen(summaries: dict, folder: str, open_month: str | None,
    ...
    Reco-excluded shipments are handled UPSTREAM (dropped from the live detail
    that drives the FY total, and from the Details sheet) — the FROZEN closed
    months are signed-off and are NEVER adjusted here. Mutates & returns."""
